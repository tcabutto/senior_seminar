...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post deals_url, params: { deal: { business: @deal.business, end_date: @deal.end_date, name: @deal.name, popularity: @deal.popularity, start_date: @deal.start_date } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { business: @deal.business, end_date: @deal.end_date, name: @deal.name, popularity: @deal.popularity, start_date: @deal.start_date } }
